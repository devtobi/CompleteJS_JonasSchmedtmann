...
export const hightlightSelected = id => {
    ...
    resultsArray.forEach(result => result.classList.remove('results__link--active'));
...
const renderButtons = (page, amountRecipes, perPage) => {
    const pages = Math.ceil(amountRecipes / perPage);
    let button;
    if (page === 1 && pages > 1) {
